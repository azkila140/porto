...
const industryContent = {
    ar: {
        ...
        // Fallback for others - ideally expand this list
    },
    fr: {
        medical: {
...
export default function SolutionContent({ lang, industry }: SolutionContentProps) {
    ...
    // @ts-ignore - Temporary fix for missing content types
