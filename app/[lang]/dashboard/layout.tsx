...
export default async function DashboardLayout({
    ...
    const navItems = {
        ar: [
            { href: `/ar/dashboard`, icon: LayoutDashboard, label: 'لوحة التحكم' },
            { href: `/ar/dashboard/projects`, icon: FolderKanban, label: 'المشاريع' },
            { href: `/ar/dashboard/invoices`, icon: FileText, label: 'الفواتير' },
            { href: `/ar/dashboard/support`, icon: MessageSquare, label: 'الدعم' },
        ],
        fr: [
            { href: `/fr/dashboard`, icon: LayoutDashboard, label: 'Tableau de bord' },
            { href: `/fr/dashboard/projects`, icon: FolderKanban, label: 'Projets' },
            { href: `/fr/dashboard/invoices`, icon: FileText, label: 'Factures' },
            { href: `/fr/dashboard/support`, icon: MessageSquare, label: 'Support' },
        ],
        en: [
            { href: `/en/dashboard`, icon: LayoutDashboard, label: 'Dashboard' },
            { href: `/en/dashboard/projects`, icon: FolderKanban, label: 'Projects' },
            { href: `/en/dashboard/invoices`, icon: FileText, label: 'Invoices' },
            { href: `/en/dashboard/support`, icon: MessageSquare, label: 'Support' },
        ],
    }
