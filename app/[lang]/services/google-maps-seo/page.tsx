    ...
    ar: {
        ...
        process: {
            ...
            steps: [
                ...
                {
                    number: 2,
                    title: 'الإعداد والتحسين',
                    description: 'نحسن ملف Google Business، نضيف صور عالية الجودة، ونكمل جميع المعلومات',
                    duration: '1 أسبوع'
                },
                {
                    number: 3,
                    title: 'بناء الاستشهادات',
                    description: 'نضيف نشاطك إلى 50+ دليل محلي ومنصة ذات صلة بمجالك',
                    duration: '2-3 أسابيع'
                },
                {
                    number: 4,
                    title: 'المراقبة والتحسين',
                    description: 'نراقب الأداء، نحسن بناءً على البيانات، ونقدم تقارير شهرية',
                    duration: 'مستمر'
                }
            ]
        },
