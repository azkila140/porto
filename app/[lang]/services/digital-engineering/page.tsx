...
const content = {
    ar: {
        hero: {
            title: 'برمجة تطبيقات ومواقع الكترونية مخصصة',
            subtitle: 'شركات برمجة في الرياض - حلول تقنية متكاملة',
            description: 'نحن في نيكسس لوجيك نتخصص في برمجة تطبيقات الجوال وتصميم مواقع الكترونية متقدمة باستخدام أحدث التقنيات لضمان تفوق أعمالك في السوق الرقمي وتطوير منصات رقمية قابلة للتوسع.',
        ...
        details: {
            ...
            paragraphs: [
                'تعتبر برمجة التطبيقات والمنصات هي العمود الفقري لأي تحول رقمي ناجح. نحن لا نقوم فقط بكتابة الأكواد، بل نقوم بتصميم أنظمة متكاملة قابلة للتوسع. نستخدم تقنيات متطورة مثل Next.js 15 و React لضمان أعلى مستويات الأداء والسرعة، مما ينعكس بشكل مباشر على تجربة المستخدم ومعدلات التحويل (Conversion Rates).',
                'في سوق مليء بالحلول الجاهزة، تتميز نيكسس لوجيك بتقديم تطوير مخصص بالكامل (Custom Development). سواء كنت تبحث عن تصميم متجر الكتروني متكامل أو نظام إدارة موارد (ERP)، فإن كل سطر برمج يتم كتابته لخدمة أهدافك التجارية وتحقيق أعلى معايير الأمان (Cybersecurity).',
                'نحن نتبع معايير هندسية صارمة في حماية البيانات وتأمين الواجهات البرمجية (APIs). من خلال خدمات Digital Transformation KSA، نضمن أن تكون منصتك قوية ومستقرة وقادرة على التعامل مع آلاف المستخدمين في وقت واحد.'
            ]
        },
        features: {
            ...
            items: [
                {
                    ...
                    description: 'بناء مواقع ويب سريعة جداً ومتجاوبة بالكامل باستخدام Next.js مع التركيز على Technical SEO لضمان التصدر.'
                },
                {
                    icon: 'Smartphone',
                    title: 'برمجة تطبيقات الجوال',
                    description: 'تطوير تطبيقات iOS و Android أصلية (Native) أو عابرة للمنصات (Cross-platform) تمنح مستخدميك تجربة سلسة.'
                },
                {
                    icon: 'Cloud',
                    title: 'البنية التحتية السحابية',
                    description: 'تصميم وإدارة بيئات سحابية على AWS و Google Cloud لضمان توفر الخدمة بنسبة 99.9% وقابلية التوسع.'
                },
                {
                    icon: 'Database',
                    title: 'إدارة البيانات الضخمة',
                    description: 'تصميم قواعد بيانات متطورة تضمن سلامة البيانات وسرعة الوصول إليها، مع تكامل كامل مع أنظمة التحليلات.'
                },
                {
                    icon: 'Zap',
                    title: 'APIs و Microservices',
                    description: 'بناء واجهات برمجية قوية وخدمات مصغرة تتيح لأنظمتك التواصل بسلاسة وتسهل عملية التطوير المستقبلي.'
                },
                {
                    icon: 'Shield',
                    title: 'الأمن السيبراني',
                    description: 'تطبيق أحدث بروتوكولات الأمان والتشفير لحماية معلوماتك ومعلومات عملائك من التهديدات السيبرانية.'
                }
            ]
        },
        process: {
            ...
            steps: [
                {
                    ...
                    description: 'نبدأ بفهم احتياجاتك وأهدافك، ثم نضع خطة تفصيلية للمشروع مع تحديد التقنيات والميزانية',
                    duration: '1-2 أسابيع'
                },
                {
                    number: 2,
                    title: 'التصميم UI/UX',
                    description: 'نصمم واجهات مستخدم جذابة وتجربة مستخدم سلسة، ونقدم نماذج تفاعلية للمراجعة',
                    duration: '2-3 أسابيع'
                },
                {
                    number: 3,
            ...
            items: [
                {
                    ...
                    tags: ['E-commerce Development', 'Next.js', 'Online Store']
                },
                {
                    ...
                    tags: ['Mobile App', 'React Native', 'ERP System']
                }
            ]
        },
        faq: [
            {
                q: 'كم تكلفة برمجة تطبيق أو موقع الكتروني؟',
                a: 'تبدأ تكلفة المواقع التعريفية من 15,000 ريال، والمتاجر الإلكترونية المخصصة من 40,000 ريال. أما برمجة التطبيقات المتكاملة فتبدأ من 80,000 ريال وتعتمد على التعقيد والميزات المطلوبة.'
            },
            {
                q: 'كم يستغرق تطوير منصة ويب كاملة؟',
                a: 'عادة 8-16 أسبوع حسب التعقيد: أسبوعين للتخطيط والتصميم، 4-8 أسابيع للبرمجة والتطوير، وأسبوعين للاختبار والإطلاق.'
            }
        ],
        cta: {
            title: 'جاهز لبدء مشروعك التقني؟',
            description: 'تواصل معنا اليوم للحصول على استشارة مجانية وعرض سعر لبرمجة تطبيقك'
        }
    },
    fr: {
        hero: {
