...
const content = {
    ar: {
        hero: {
            title: 'تسويق الأداء وإدارة حملات ممولة',
            subtitle: 'وكالة تسويق رقمي - إعلانات جوجل ومنصات التواصل',
            description: 'نحن نبني حضورك الرقمي من خلال استراتيجيات تسويق الأداء (Performance Marketing)، صناعة محتوى إبداعي، وإدارة حملات إعلانية تهدف لتحويل المشاهدين إلى عملاء وتشقيق أعلى عائد.',
        ...
        details: {
            ...
            paragraphs: [
                'في عصر الاقتصاد الرقمي، التسويق بالمحتوى هو الوقود الذي يحرك ماكينة النمو. بصفتنا وكالة تسويق رقمي متخصصة، نتجاوز مجرد النشر العشوائي لنصمم رحلة كاملة يمر بها العميل (Customer Journey). نحن نؤمن أن الفيديو القصير وكتابة المحتوى المتوافق مع محركات البحث (SEO Content) هما المفتاحان لبناء الثقة.',
                'استراتيجية النمو (Growth Strategy) لدينا تعتمد على البيانات. نقوم بتحليل سلوك جمهورك وتطوير محتوى يلمس احتياجاتهم. من خلال الجمع بين الإبداع الفني والتحليل التقني، نضمن أن كل حملة إعلانية (PPC Campaign) ننتجها تساهم بشكل مباشر في زيادة معدل التحويل (CRO) وتحقيق عائد حقيقي.',
                'سواء كنت تسعى لتصدر نتائج البحث العضوية أو إطلاق حملات إعلانية ضخمة على جوجل (Google Ads) ومنصات التواصل، فإن فريقنا المتكامل يعمل بتناغم لتحقيق أهدافك. نحن نfocus على النمو المستدام الذي يبني قاعدة عملاء مخلصة تدعم نمو شركتك.'
            ]
        },
        features: {
            ...
            items: [
                {
                    ...
                    description: 'فيديوهات تسويقية احترافية، ريلز، شورتس، وفيديوهات موشن جرافيك تجذب الانتباه وتزيد التفاعل.'
                },
                {
                    icon: 'FileText',
                    title: 'كتابة المحتوى (Copywriting)',
                    description: 'محتوى تسويقي مقنع، مقالات SEO لمدونتك، نصوص إعلانية، ومحتوى سوشيال ميديا يحقق نتائج.'
                },
                {
                    icon: 'TrendingUp',
                    title: 'استراتيجية النمو',
                    description: 'خطط نمو مخصصة تجمع بين التسويق الرقمي، المحتوى، والإعلانات (Paid Media) لتحقيق أهدافك.'
                },
                {
                    icon: 'Target',
                    title: 'إدارة الحملات الإعلانية',
                    description: 'إدارة حملات Google Ads و Facebook Ads مع استهداف دقيق وتحسين مستمر للعائد على الإنفاق (ROAS).'
                },
                {
                    icon: 'BarChart3',
                    title: 'تحليل وتحسين (Analytics)',
                    description: 'تتبع الأداء باستخدام أدوات متقدمة، تحليل البيانات، وتحسين الحملات بناءً على النتائج الفعلية.'
                },
                {
                    icon: 'Megaphone',
                    title: 'إدارة السوشيال ميديا',
                    description: 'إدارة كاملة لحساباتك على منصات التواصل مع محتوى يومي وجدول نشر منتظم (Content Calendar).'
                }
            ]
        },
        process: {
            ...
            steps: [
                {
                    ...
                    description: 'ندرس وضعك الحالي، جمهورك، ومنافسيك، ثم نضع استراتيجية نمو شاملة بالأرقام',
                    duration: '1 أسبوع'
                },
                {
                    number: 2,
                    title: 'إنتاج المحتوى',
                    description: 'ننتج محتوى عالي الجودة (فيديو، مقالات، تصاميم) حسب الخطة التسويقية',
                    duration: 'مستمر'
                },
                {
                    number: 3,
                    title: 'إطلاق الحملات',
                    description: 'ننشر المحتوى ونطلق الحملات الإعلانية المستهدفة على المنصات المختارة',
                    duration: 'مستمر'
                },
                {
                    number: 4,
                    title: 'القياس والتحسين',
                    description: 'نتتبع النتائج، نحلل البيانات، ونحسن معدلات التحويل لتحقيق أفضل عائد',
                    duration: 'مستمر'
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    tags: ['E-commerce Growth', 'Video Marketing', 'Paid Ads']
                },
                {
                    ...
                    tags: ['SEO Strategy', 'Content Marketing', 'Lead Generation']
                }
            ]
        },
        faq: [
            {
                q: 'كم تكلفة خدمات التسويق وإدارة الحملات؟',
                a: 'باقات النمو تبدأ من 8,000 ريال شهرياً (إدارة سوشيال ميديا + محتوى)، 18,000 ريال (إضافة حملات إعلانية PPC وفيديو)، و35,000+ ريال (استراتيجية شاملة + SEO + إنتاج متقدم).'
            },
            {
                q: 'ما العائد المتوقع من استثمار التسويق بالمحتوى؟',
                a: 'عادة العائد على الاستثمار (ROI) يصل 3-5x خلال 6-12 شهر من الاستثمار المستمر. عملاؤنا يحققون معدل نمو 150-300% في اكتساب العملاء الجدد خلال السنة الأولى.'
            }
        ],
        cta: {
