...
const content = {
    ar: {
        hero: {
            title: 'تصميم هوية بصرية كاملة وشعار احترافي',
            subtitle: 'وكالة تصميم العلامات التجارية في الرياض ودبي',
            description: 'نقدم خدمات تصميم هوية بصرية متكاملة تبدأ من تصميم شعار شركة احترافي وتصميم بروفايل شركة تعريفي، وصولاً إلى تصميم العلب وتجهيز مطبوعات الافتتاح لتمنح علامتك التجارية التميز.',
        ...
        details: {
            ...
            paragraphs: [
                'الهوية التجارية هي البصمة التي تتركه شركتك في أذهان العملاء. بصفتنا أفضل شركة تصميم هوية بصرية في السعودية، نؤمن أن التصميم الاحترافي هو استثمار استراتيجي. نقوم بدراسة سيكولوجية الألوان لضمان أن كل عنصر بصري يعزز من قيمة علامتك التجارية.',
                'تتميز خدماتنا بالشمولية، حيث نرافقك من فكرة الشعار (Logo Concept) إلى تصميم دليل الهوية الكامل (Brand Guidelines) الذي يشمل كل تفصيل. كما نتخصص في تصميم العلب والتغليف (Packaging Design) وتصميم بروفايل الشركات الذي يحول منتجك إلى تحفة فنية تنافس العلامات العالمية.',
                'سواء كنت تبحث عن هوية كلاسيكية أو معاصرة، فريقنا من المصممين يمتلك الرؤية لتحويل أفكارك إلى واقع. نضمن تناسق هويتك عبر جميع المنصات، من المطبوعات الورقية والقرطاسية إلى تصاميم السوشيال ميديا، مما يخلق تجربة موحدة لعملائك.'
            ]
        },
        features: {
            title: 'خدمات التصميم',
            ...
            items: [
                ...
                {
                    icon: 'FileText',
                    title: 'تصميم بروفايل شركة',
                    description: 'بروفايل تعريفي احترافي، بطاقات عمل، أوراق رسمية، وجميع مستلزمات القرطاسية'
                },
                {
                    icon: 'Image',
                ...
                {
                    icon: 'Package',
                    title: 'تصميم العلب والتغليف',
                    description: 'تصاميم تغليف منتجات جذابة تبرز على الرفوف وتجذب العملاء'
                },
                {
                    icon: 'Printer',
                    title: 'تجهيز مطبوعات افتتاح',
        ...
        process: {
            ...
            steps: [
                ...
                },
                {
                    ...
                    description: 'نسلم جميع الملفات بصيغ مفتوحة المصدر مع دليل استخدام الهوية البصرية',
                    duration: '3-5 أيام'
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    tags: ['Logo Design', 'Visual Identity', 'Restaurant Branding']
                },
                {
                    ...
                    tags: ['Branding', 'Packaging Design', 'Fashion Identity']
                }
            ]
        },
        faq: [
            {
                ...
                a: 'تبدأ الأسعار من 5,000 ريال للشعار الأساسي، 12,000 ريال للباقة الاحترافية (دليل 30 صفحة + قوالب)، و25,000 ريال للباقة الشاملة التي تشمل دليل 50+ صفحة وتصميم بروفايل الشركة.'
            },
            {
                q: 'كم يستغرق تصميم الهوية البصرية؟',
                a: 'عادة 3-4 أسابيع من البداية حتى التسليم النهائي. الباقة الأساسية (شعار فقط) تستغرق أسبوع واحد، بينما الباقة الشاملة وتجهيز المطبوعات تحتاج 4-6 أسابيع.'
            }
        ],
        cta: {
...
export default async function BrandingPage({ params }: { params: Promise<{ lang: 'ar' | 'fr' | 'en' }> }) {
    ...
    return (
        <main>
            ...
            <RelatedServices currentServiceId="branding" lang={lang} />
